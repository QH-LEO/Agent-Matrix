        ...
        <section class="control-panel">
          ...
          <div class="control-panel-content">
            ...
            <SkillEditor
              ...
              @add-default-skill="studio.addDefaultSkill"
              @set-default-skill-field="studio.setDefaultSkillField"
              @delete-default-skill="studio.deleteDefaultSkill"
            ...
            <CompilerPreview
              ...
              :syncing-definition="studio.syncingDefinition"
              @preview-compile="studio.previewCompile"
              @apply-compile="studio.applyCompile"
              @sync-definition="studio.syncDefinitionFromSystem"
